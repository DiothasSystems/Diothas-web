---
title: "VW Gets It, Tesla Doesn't"
subtitle: Dominant design, and knowing where innovation actually belongs.
category: "PRODUCT STRATEGY"
author: DIOTHAS SYSTEMS
date: 2026-07-11
icon: icon.png
summary: >
  Far too often we want to innovate for the sake of innovation and we ignore
  that the solution is already well established as the dominant design.
draft: false
---
...
![An early mechanical typewriter with the QWERTY keyboard layout.](images/qwerty-typewriter.jpg "QWERTY outlived the typebar jam it was designed to prevent. The dominant design survives the very problem that created it.")
...
![An adjustable air vent with a physical directional nub.](images/air-vent.jpg "The nickel solution: aimed by feel, adjusted without looking, understood by everyone. A solved problem.")

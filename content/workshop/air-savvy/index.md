...
Air Savvy started as a personal itch. I plan trips ten to twelve months out, and the one variable I could never time was the airfare, which drifts up and down for reasons a buyer can't see. I wanted an agent that would watch specific flights every day and tell me when to buy, and figured anyone who books that far ahead could use the same thing.
